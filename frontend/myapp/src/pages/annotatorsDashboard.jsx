        ...
        <div style={{ maxWidth: 1080, margin: "0 auto", padding: "24px 16px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 18, flexWrap: "wrap" }}>
            <div style={{ flex: "1 1 60%" }}>
              <input style={inputStyle} type="text" placeholder="Search by entity, virtues, keywords, or story text..." value={search} onChange={(e) => setSearch(e.target.value)} />
            </div>
            ...
            <div ref={formRef} style={{ background: C.surface, borderRadius: 16, border: `1px solid ${C.border}`, boxShadow: darkMode ? "0 4px 20px rgba(0,0,0,0.3)" : "0 4px 20px rgba(91,79,207,0.1)", marginBottom: 18, overflow: "hidden" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 18px 12px", borderBottom: `1px solid ${C.border}` }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  {/* ← Back button */}
                  <button onClick={closeForm} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "transparent", border: `1px solid ${C.border}`, color: C.text2, fontSize: 13, fontWeight: 500, fontFamily: "inherit", padding: "6px 12px", borderRadius: 999, cursor: "pointer", transition: "all 0.18s" }}
              ...
              <div style={{ padding: "16px 18px 20px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px 16px", marginBottom: 12 }}>
                  <div>
                    <label style={{ fontSize: 13, fontWeight: 600, color: C.text2, display: "block", marginBottom: 6 }}>Entity / Name <span style={{ color: "#dc2626" }}>*</span></label>
                    <input style={inputStyle} placeholder="e.g., Abraham Lincoln, Gandhi" value={form.entity} onChange={(e) => setForm({ ...form, entity: e.target.value })} ref={entityRef} />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input style={inputStyle} placeholder="e.g., Honesty, Courage, Compassion" value={form.virtues} onChange={(e) => setForm({ ...form, virtues: e.target.value })} />
                  </div>
                  <div>
                    <label style={{ fontSize: 13, fontWeight: 600, color: C.text2, display: "block", marginBottom: 6 }}>Keywords / Synonyms</label>
                    <input style={inputStyle} placeholder="e.g., truth, integrity, honesty" value={form.keywords} onChange={(e) => setForm({ ...form, keywords: e.target.value })} />
                  </div>
                  <div style={{ gridColumn: "1 / -1" }}>
                    <label style={{ fontSize: 13, fontWeight: 600, color: C.text2, display: "block", marginBottom: 6 }}>Story Text <span style={{ color: "#dc2626" }}>*</span></label>
                    <textarea rows={7} style={{ ...inputStyle, resize: "vertical", minHeight: 80, lineHeight: 1.5 }} placeholder="Enter the complete story here..." value={form.story_text} onChange={(e) => setForm({ ...form, story_text: e.target.value })} />
                ...
                <div style={{ marginTop: 16, padding: 12, borderRadius: 12, border: `1px solid ${C.border}`, background: C.surface2 }}>
                  ...
                  <ul style={{ margin: 0, paddingLeft: 18, fontSize: 13, color: C.text3 }}>
                    <li><strong style={{ color: C.text2 }}>Entity/Name</strong> and <strong style={{ color: C.text2 }}>Story Text</strong> are required.</li>
                    ...
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 10, flex: 1 }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                          {s.age_group && <span style={{ borderRadius: 999, padding: "3px 9px", fontSize: 11, fontWeight: 500, background: darkMode ? "#1a2d4a" : "#dbeafe", color: darkMode ? "#93c5fd" : "#1d4ed8" }}>{s.age_group}</span>}
                          {s.virtues  && s.virtues.split(",").slice(0, 3).map((v, i) => <span key={i} style={{ borderRadius: 999, padding: "3px 9px", fontSize: 11, fontWeight: 500, background: darkMode ? "#2d1a4a" : "#f3e8ff", color: darkMode ? "#c4b5fd" : "#6b21a8" }}>{v.trim()}</span>)}
                          {s.keywords && s.keywords.split(",").slice(0, 2).map((k, i) => <span key={i} style={{ borderRadius: 999, padding: "3px 9px", fontSize: 11, fontWeight: 500, background: darkMode ? "#0f2d1a" : "#dcfce7", color: darkMode ? "#86efac" : "#15803d" }}>{k.trim()}</span>)}
                        </div>
